...
with DAG(
    ...
    schedule="@daily",
    start_date=pendulum.datetime(2024, 1, 27),
    catchup=True,
) as dag:
    ...
    # Defina la dependencia entre las tasks basado en los requerimientos anteriores
    descargar_ficheros >> latest_only >> comprobar_usuarios_file >> procesar_usuarios_file >> backup_usuarios
